...
public class Service1Controller {
    ...
    public ResponseService2 getResponseService2(Integer service2Id) {
        return retryTemplate.execute(retryContext -> {
            ...
            ResponseEntity<ResponseService2> responseService2ResponseEntity = restTemplate.getForEntity(SERVICE2_URL + "/" + service2Id, ResponseService2.class);
            ...
            log.info("Retry count exhausted. returning null");
            return null;
        });
